...
id0 = cmp_records(cmp_index, 3);
id1 = cmp_records(cmp_index, 4);
S_A = cmp_records(cmp_index, 2); % 1:A wins, 0:B wins, 2:Tie
if S_A == 2
    S_A = 0.5;
end
...
delta2_B = get_delta2(F, item_models, id1, cmp_records, qtype);
